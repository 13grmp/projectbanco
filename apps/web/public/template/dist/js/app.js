...
//                NÃO DESCOMENTAR 
//              O QUE FOI COMENTADO
//       CASO NÃO SAIBA O QUE ESTEJA FAZENDO
//                  OBRIGADO!!
        ...
        !t ||
            ...
            (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = u),
                ...
                Array.from(document.querySelector("#two-column-menu ul").querySelectorAll("li a")).forEach(function (a) {
                    ...
                    a.addEventListener("click", function (e) {
                        var t;
                        if ((o != "/" + a.getAttribute("href") || a.getAttribute("data-bs-toggle")) && document.body.classList.contains("twocolumn-panel")) {
                        ...
                        if (((e.target && e.target.matches("a.nav-icon")) || (e.target && e.target.matches("i")))) {
                            ...
                            var targetElement = e.target.matches("i") ? e.target.closest("a") : e.target;
                            targetElement.classList.add("active");

                            var t = (e.target.matches("i") ? e.target.closest("a") : e.target).getAttribute("href").slice(1);
                            var parentElement = document.getElementById(t).parentElement;

                            var isButton = parentElement.querySelector("button"); // Verifica se há um botão dentro do elemento
                            if (isButton) {
                                console.log('teste')
                                isButton.click(); // Aciona o evento onclick do botão
                            } else {
                                console.log('teste')
                                var tItems = document.getElementsByClassName("twocolumn-item-show");
                                if (tItems.length > 0) {
                                    tItems[0].classList.remove("twocolumn-item-show");
                                }
                            ...
                            if (o != "/" + a.getAttribute("href") || a.getAttribute("data-bs-toggle")) {
